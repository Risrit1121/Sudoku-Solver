#!/usr/bin/python
# -*- coding: utf-8 -*-
from sudoku import isvalid, sudokusolve, returnZero
...
class Board:
    ...
    def redraw(
        ...
        if wrong > 0:
            ...
            font = pygame.font.SysFont('Chalkboard', 40)  
    ...
    def visualSolve(self, wrong, time):
        ...
        empty = returnZero(self.board)
        if not empty:
            return True

        for nums in range(9):
            if isvalid(self.board, (empty[0], empty[1]), nums + 1):
